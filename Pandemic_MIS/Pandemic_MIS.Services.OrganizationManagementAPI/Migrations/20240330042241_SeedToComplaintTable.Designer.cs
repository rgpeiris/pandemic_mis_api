...
namespace Pandemic_MIS.Services.OrganizationManagementAPI.Migrations
{
    ...
    [Migration("20240330042241_SeedToComplaintTable")]
    partial class SeedToComplaintTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.OrganizationManagementAPI.Models.Complaint", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8726)
                        });
                });
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.OrganizationManagementAPI.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8641),
                        ...
                        new
                        {
                            ...
                            ContactName = "Test 2",
                            CreatedBy = "ad_rpeiris",
                            CreatedDate = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8689),
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.OrganizationManagementAPI.Models.PandemicContact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PandemicContactId = 1,
                            Address = "Colombo",
                            CheckInTime = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8706),
                            CheckOutTime = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8707),
                            CreatedBy = "ad_rpeiris",
                            CreatedDate = new DateTime(2024, 3, 30, 9, 52, 40, 606, DateTimeKind.Local).AddTicks(8708),
                            Name = "Nisha Perera",
