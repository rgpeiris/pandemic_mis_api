...
namespace Pandemic_MIS.Services.OrganizationManagementAPI.Migrations
{
    ...
    [Migration("20240128115158_AddAddressToPandemicContactsTable")]
    partial class AddAddressToPandemicContactsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.OrganizationManagementAPI.Models.Organization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 1, 28, 17, 21, 57, 861, DateTimeKind.Local).AddTicks(1049),
                        ...
                        new
                        {
                            ...
                            ContactName = "Test 2",
                            CreatedBy = "ad_rpeiris",
                            CreatedDate = new DateTime(2024, 1, 28, 17, 21, 57, 861, DateTimeKind.Local).AddTicks(1091),
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.OrganizationManagementAPI.Models.PandemicContact", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PandemicContactId = 1,
                            Address = "Colombo",
                            CheckInTime = new DateTime(2024, 1, 28, 17, 21, 57, 861, DateTimeKind.Local).AddTicks(1106),
                            CheckOutTime = new DateTime(2024, 1, 28, 17, 21, 57, 861, DateTimeKind.Local).AddTicks(1107),
                            CreatedBy = "ad_rpeiris",
                            CreatedDate = new DateTime(2024, 1, 28, 17, 21, 57, 861, DateTimeKind.Local).AddTicks(1108),
                            Name = "Nisha Perera",
