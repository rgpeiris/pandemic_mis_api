...
namespace Pandemic_MIS.Services.PandemicTestsManagementAPI.Migrations
{
    ...
    [Migration("20240228095934_AddTestingTypeToDb")]
    partial class AddTestingTypeToDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.PandemicTest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8356),
                        ...
                        new
                        {
                            PandemicTestId = 2,
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8417),
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.PandemicTestResult", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 32,
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8536),
                            DateOfPandemicTest = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8534),
                            District = "Colombo",
                            Gender = "Female",
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.ScheduledTestCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8481),
                            DateScheduled = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8478),
                            TestCentreId = 1,
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.TestCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Piliyandala",
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8449),
                            District = "Colombo",
                            IsActive = true,
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.TestsAppointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8509),
                            DateScheduled = new DateTime(2024, 2, 28, 15, 29, 34, 168, DateTimeKind.Local).AddTicks(8507),
                            Gender = "Female",
                            NICNumber = "917283783V",
                            Name = "Janvi Fernando",
                            PhoneNumber = "772523191",
