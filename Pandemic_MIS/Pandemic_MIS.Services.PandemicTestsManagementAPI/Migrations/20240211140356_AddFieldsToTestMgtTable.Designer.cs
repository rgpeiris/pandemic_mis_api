...
namespace Pandemic_MIS.Services.PandemicTestsManagementAPI.Migrations
{
    ...
    [Migration("20240211140356_AddFieldsToTestMgtTable")]
    partial class AddFieldsToTestMgtTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.PandemicTest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5807),
                        ...
                        new
                        {
                            PandemicTestId = 2,
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5856),
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.PandemicTestResult", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Age = 32,
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5951),
                            DateOfPandemicTest = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5948),
                            District = "Colombo",
                            Gender = "Female",
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.ScheduledTestCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5906),
                            DateScheduled = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5903),
                            TestCentreId = 1,
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.TestCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Piliyandala",
                            CreatedBy = "hp_anushka",
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5881),
                            District = "Colombo",
                            IsActive = true,
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.TestsAppointment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5929),
                            DateScheduled = new DateTime(2024, 2, 11, 19, 33, 55, 594, DateTimeKind.Local).AddTicks(5927),
                            Gender = "Female",
                            NICNumber = "917283783V",
                            Name = "Janvi Fernando",
                            PhoneNumber = "772523191",
