...
namespace Pandemic_MIS.Services.PandemicTestsManagementAPI.Migrations
{
    ...
    [Migration("20231221112345_SeedScheduledTestCentresTable")]
    partial class SeedScheduledTestCentresTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pandemic_MIS.Services.PandemicTestsManagementAPI.Models.ScheduledTestCentre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateScheduled = new DateTime(2023, 12, 21, 16, 53, 45, 3, DateTimeKind.Local).AddTicks(4870),
                            TestCentreId = 1,
